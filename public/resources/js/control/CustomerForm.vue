        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <the-mask
                        class="form-control" v-model="driver.phone" type="tel" name="phone" required id="phone"
                        masked="masked" placeholder="Телефон" data-reload-payment-form="true"
                        mask="+### (##) ###-##-##"/>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="certificate" v-model="driver.password"
                           id="certificate">
                </div>
            </div>
...
<script>
    ...
    export default {
        name: "CustomerForm",
        props: [],
        components: {CustomerGroupSelect},
        created() {
